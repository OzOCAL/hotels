    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><strong>{$titrePage|default:'Formulaire'}</strong></div>
                    <form action="index.php" method="POST">
                        <div class="card-body card-block">
                            Id : 
                            <input type="text" name="Payment" 
                                value="{$id|default:$unPaymentType->getPayment()|default:''}" 
                                readonly><br>
                            Description : 
                            <input type="text" name="Description" 
                                value="{$unPaymentType->getDescription()|default:''}">
                        </div>
                        <div class="card-body card-block">
