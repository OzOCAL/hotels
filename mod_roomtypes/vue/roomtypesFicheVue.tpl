                ...
                <div class="col-md-6">
                    ...
                    <div class="card">
                        ...
                        <form action="index.php" method="POST">
                            ...
                            Numéro type chambre : 
                            <input type="text" name="RoomType" value="{$id|default:$roomtype->getRoomType()|default:''}" readonly><br>
                            Nombre de lits : 
                            <input type="text" name="Beds" value="{$roomtype->getBeds()|default:''}"><br>
                            Description : 
                            <input type="text" name="Description" value="{$roomtype->getDescription()|default:''}"><br>
                            </div>
                            <div class="card-body card-block">
