<?php
/* Smarty version 4.3.4, created on 2024-11-26 23:50:23
  from '/Applications/MAMP/htdocs/hotels/public/left.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_67465ebfc210a3_18156336',
...
function content_67465ebfc210a3_18156336 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- Left Panel -->
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="index.php?gestion=rooms">Chambres</a></li>
                            <li><i class="fa fa-table"></i><a href="index.php?gestion=roomtypes">Types de chambre</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
